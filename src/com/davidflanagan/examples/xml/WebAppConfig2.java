...
public class WebAppConfig2 {
	...
	for(Iterator i = servlets.iterator(); i.hasNext(); ) {
	    ...
	    String name = String.valueOf(servlet.getChild("servlet-name").getContent());
	    if (name.equals(servletName)) {
		// If the names match, return the text of the <servlet-class>
		return String.valueOf(servlet.getChild("servlet-class").getContent());
	    }
	}
	return null;
    }
	...
	Element parent = (Element) firstServlet.getParent();
